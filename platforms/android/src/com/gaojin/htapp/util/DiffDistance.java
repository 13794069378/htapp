...
public class DiffDistance {
	...
	private DiffDistance(){}
	private static DiffDistance instance;
	
	public static synchronized DiffDistance getInstance(){
		if(instance == null){
			instance = new DiffDistance();
		}
		return instance;
	}
	/**
	...
	public static void main(String[] args) {
		 ...
		 * 
		 */
		double lat1 =  23.018125;//纬度
		double lon1 = 113.106185;//经度
		
		double lat2 =  23.018073;//纬度
		double lon2 = 113.1061;//经度
		System.out.println(new DiffDistance().getShortDistance(lon1, lat1, lon2, lat2));
	}
}
